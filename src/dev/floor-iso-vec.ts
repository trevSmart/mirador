 ...
 *  - azimuthDeg = 45, tilt = 0.5  → exactly the official 2:1 isometric look.
 *  - azimuthDeg ≠ 45              → dimetric: `u` and `v` stop being mirrors,
 *    so grid diagonals no longer collapse onto a single screen column.
 */
