...
- Resolved an issue where a white background box appeared on mouseover of a cell if any column rendered with a custom component like button. The fix applied in the context of `slds-cell-wrap` class is now applicable by default.
