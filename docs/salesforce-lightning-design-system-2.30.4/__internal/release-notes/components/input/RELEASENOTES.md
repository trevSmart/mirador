...
- Added an example to represent input with error icon in a horizontal form.

### Updated
- Setting the padding to 0 in the mobile-specific CSS for native date type inputs.
