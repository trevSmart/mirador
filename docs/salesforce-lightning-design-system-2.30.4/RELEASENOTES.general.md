...
## 2.30.3 - April 21, 2026

- Updated `@salesforce-ux/icons` to version `v10.15.2`
  - Utility set
    - Added alt_agent_astro

## 2.30.2 - April 20, 2026

- Fixed dist build to properly copy image assets and remove utf-8 encoding

## 2.30.1 - April 14, 2026

## 2.30.0 - April 6, 2026

- Updated `@salesforce-ux/icons` to version `v10.15.1`
  - Standard set
    - Updated shift_ui
  - Utility set
    - Added data_governance

- Updated `@salesforce-ux/sds-styling-hooks` to version `2.0.0-beta.14`.
- Updated `@salesforce-ux/icons` to version `v10.15.0`
  - Standard set
    - Added rcs_message
    - Added send_to_flow
    - Added shift_ui
    - Added inspector_brief
    - Added table_code
    - Added record_companion_agent
    - Added hierarchy_table
  - Utility set
    - Added in_app_messaging
    - Added scheduling_policy
    - Added rcs_message
    - Added alt_lock
    - Added recenter_alt
    - Added slack_microphone
    - Added slack_video
    - Added slack_image
    - Added slack_message
    - Added slack_list_item
    - Added slack_list
    - Added slack_new_window
    - Added recent
    - Added table_code
    - Added slack_canvas_content
    - Added inspector_brief
    - Added voice_mode
    - Added hierarchy_table
    - Added conversation_catch_up
    - Added einstein_replies
    - Added operations_plan
    - Added table_checked
    - Added table_interpreter
    - Added table_sparkle
    - Added slack_file
    - Added two_way
    - Added alt_unlock
...
## 2.29.0 - December 29, 2025

## Updated

- Updated `@salesforce-ux/sds-styling-hooks` to version `2.0.0-beta.13`.

- Updated icons to `v10.14.1`
  - Standard Set:
    - Added ai_slack_summary
    - Added end_call
    - Added in_app_messaging
    - Added mcp_server
    - Added play
  ...
  - Utility Set:
    ...
    - Added dataspace
    - Added dataspaces
    - Added environment_hub
    - Added identified_guest
    - Added pref_dataspace
    - Added price_sheet
    - Added similar_case
    - Added slack_huddles
    - Added slack_lock_filled
    - Added slack_thumbs_down
    - Added slack_thumbs_up
    - Added slack_trash
    - Added slack_user_group
    - Added voicemail_drop_alt
    - Updated merge_field
